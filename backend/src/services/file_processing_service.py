...
from src.services.file_service import delete_uploaded_file, get_user_upload_dir, vectorize_and_store
...
def _active_key(job_type: str, user_id: int, source_document_id: int | None) -> str:
    if job_type == "restore":
