    ...
    return {
        ...
        "content": "\n\n".join(
            [
                ...
                "欢迎来到 AI Blog。它不只是展示文章的博客系统，更是一个为长期写作与知识积累准备的空间。你可以从一条灵感开始，逐步沉淀资料、梳理观点、完成文章，并把可靠的内容发布出去。",
                "## 你可以在这里做什么",
                ...
                "## 让 AI 服务于你的表达",
                "好的写作仍然需要你的经验、取舍和立场。AI Blog 希望帮你减少整理和重复劳动，把更多时间留给思考：为什么这个问题值得写？证据是否足够？读者真正需要得到什么？",
                "当你保留这些判断，AI 就能成为可靠的协作者——帮助你更稳定地思考、更高效地整理、更有依据地写作。",
                "## 现在就开始\n\n新建一篇文章，写下你最近想弄明白的一件事。无需等到准备充分；一个清晰的问题，就是一篇好文章的开始。",
            ]
        ),
    }
