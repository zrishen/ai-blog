...
export function FilePreviewPane() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 h-full overflow-hidden bg-background px-2 py-2">
      <div className="mx-auto flex w-full max-w-[1040px] flex-1 min-h-0 flex-col overflow-hidden rounded-2xl border border-border/70 bg-card/90 shadow-xl shadow-foreground/5">
