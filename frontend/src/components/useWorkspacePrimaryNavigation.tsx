...
import { FolderOpen, Home, Network, type LucideIcon } from "lucide-react";
import { useChatDispatch } from "@/stores/chatStore";
import { useAuth, type AuthUser } from "@/stores/authStore";

export type PrimaryNavigationKey = "home" | "files" | "research";
...
export function useWorkspacePrimaryNavigation() {
  ...
  const activePrimaryPage: PrimaryNavigationKey | null = location.pathname === "/files"
    ? "files"
  ...
  ], [handleFiles, handleHome, handleResearch]);
